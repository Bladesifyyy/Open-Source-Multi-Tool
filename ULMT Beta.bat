...
cls
chcp 65001 >nul
title ULMT - Ultimate Multi-Tool Beta v1.0.5
color D
:menu
cls
echo                 ┌────────────────────────────────────────────┐
...
echo                 │  ██║   ██║██║     ██║╚██╔╝██║   ██║        │
echo                 │  ╚██████╔╝███████╗██║ ╚═╝ ██║   ██║        │
echo                 │   ╚═════╝ ╚══════╝╚═╝     ╚═╝   ╚═╝[97mBetav1.0[95m│
echo                 └────────────────────────────────────────────┘
echo		        [95m╦ [95m╦┬ ┌┬┐┬┌┬┐┌─┐┌┬┐┌─┐  ╔[95m╦╗┬ ┬┬ ┌┬┐┬  ╔[95m╦╗┌─┐┌─┐┬  
echo		        ║ ║│  │ ││││├─┤ │ ├┤   ║║║│ ││  │ │───║ │ ││ ││  
echo		        ╚═╝┴─┘┴ ┴┴ ┴┴ ┴ ┴ └─┘  ╩ ╩└─┘┴─┘┴ ┴   ╩ └─┘└─┘┴─┘  
echo                             [97mCreated By: [92mBladesify [97m©  
echo.    
echo          %date%     
echo [97m	┌──────────────────────────────────────────────────────────────┐
echo [97m	│[90mstatus[97m: [92mOnline                                        [97mV1.0.5  [97m│
echo [97m	│                                                              │
...
echo [97m	│                                                              │
echo [97m	│              [97m[[95m+[97m]  [97mFull [97mTools [91m"AKA" [31mFull Menu                 [97m│
echo [97m	│                                                              │
echo [97m	│ 15. credits                                                  │
echo [97m	│ 16. github                                                   │
...
echo [97m	└──────────────────────────────────────────────────────────────┘
echo [97m		  you need paid verison for the full menu/tool
echo.
...
@echo off
chcp 65001 >nul
title ULMT - Ultimate Multi-Tool - Logged in as [%user%]
color D
:full
cls
...
echo [97m	│ 18. batchcraft                                               │
echo [97m	└──────────────────────────────────────────────────────────────┘
echo [97m         DM  [92mBladesify  [97mTo Purchase  [97m:)
pause
goto menu
